...
Welcome to **[Capitol Trades Tracker](https://maikotrindade.com/capitol-trades-tracker/)**, a groundbreaking mobile application that combines the power of **agentic AI**, **multiple large language models (LLMs)**, and **public government data** to democratize access to political trading intelligence.
...
<img src="https://maikotrindade.com/public/img/capitol-trades-tracker-overview.png" alt="Capitol Trades Tracker" width="100%"/>
...
At the heart of Capitol Trades Tracker is an intelligent AI agent built with **[Koog](https://koog.ai)**, a cutting-edge framework for developing autonomous AI agents. This isn't just simple data retrieval—it's sophisticated, multi-layered analysis that:
