...
layout: post
description: "A practical guide to Jetpack Compose UI testing — setup, ComposeTestRule, semantic assertions, and best practices for writing reliable and maintainable Android UI tests."
---
